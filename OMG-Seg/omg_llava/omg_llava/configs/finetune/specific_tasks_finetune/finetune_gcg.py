...
from omg_llava.model.mask2former_encoder import Mask2FormerVisualEncoder #추가
...
model = dict(
    ...
    llm_lora=dict(
        ...
        bias='none',
        task_type='CAUSAL_LM'),
        #visual_encoder=omgseg_model, #원래코드
        visual_encoder=dict(
        type='Mask2FormerVisualEncoder',
        clip_model_name_or_path="openai/clip-vit-large-patch14-336",
        mask2former_model_name_or_path="facebook/mask2former-swin-large-coco-panoptic"
    ),
    tokenizer=tokenizer,
)
